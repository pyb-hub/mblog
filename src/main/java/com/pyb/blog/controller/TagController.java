...
import com.pyb.blog.service.impl.TagImpl;
...
public class TagController {
    ...
    /*标签增加的编辑页面*/
    @GetMapping("/admin/tags_manage/input")
    public String input(){
        /*跳转的地址*/
        return "/admin/tags_manage-input";
    }
    /*增加分类的编辑页面的增加表单提交的地址*/
    @PostMapping("/admin/tags_add")
    ...
    /*修改编辑按钮的跳转地址*/
    @GetMapping("/admin/tags_manage/editor/{id}")
    ...
    /*修改编辑页面重新编辑的表单提交的地址*/
    @PostMapping("/admin/tags_editor/{id}")
    public String editortag(Tag tag, @PathVariable Integer id,RedirectAttributes attributes){
    ...
    /*删除的逻辑处理*/
    @GetMapping("/admin/tags_manage/del/{id}")
